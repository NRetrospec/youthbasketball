    ...
    <div className="min-h-screen bg-court-black flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-bebas text-5xl text-white tracking-wide">Join the Community</h1>
          <p className="text-court-cream/50 font-dm text-sm mt-2">Create your free Hooper account</p>
        </div>
